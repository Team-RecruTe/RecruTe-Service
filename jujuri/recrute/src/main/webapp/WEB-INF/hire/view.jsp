...
<div class="flow-root rounded-lg border border-gray-100 py-3 shadow-sm">
	<form action="/recrute/apply-process" method="post">
    ...
    <path stroke-linecap="round" stroke-linejoin="round"
				...
				<c:otherwise>
					<button
						class="inline-flex items-center gap-2 rounded border border-teal-600 bg-teal-600 px-8 py-3 text-white hover:bg-transparent hover:text-teal-600 focus:outline-none focus:ring active:text-teal-500"> <span
						class="text-sm font-medium"> Apply </span> <svg
							class="h-5 w-5 rtl:rotate-180" xmlns="http://www.w3.org/2000/svg"
